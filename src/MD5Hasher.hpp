...
namespace Crypto
{
	...
	private:
		...
		// TODO formailze naming convention for constants within crypto classes
		// MD5 K-constants (integer parts of (2^32 * abs(sin(i+1))))
		...
		std::array<uint32_t, 16> getBlockWords(std::span<const uint8_t> chunk, int blockNumber);
